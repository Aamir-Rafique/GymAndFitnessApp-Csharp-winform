...
using static GymAndFitness.WorkoutPlansForm;

namespace GymAndFitness.Classes
{
    internal class WorkoutPlansFormClass
    {
        public static async Task WorkoutPlansFormLoadEvents(System.Windows.Forms.Timer timerForPics, PictureBox pbMembershipStatus, PictureBox pbProfilePicture, DataGridView dgvWorkoutPlan, ComboBox cmbExercise, ComboBox cmbWorkoutType, Button btnSaveWorkoutPlan)
        {
            ...
            if (UserDataManager.CurrentUser != null)
            {
                ...
                PremiumFeatureWorkoutPlan(btnSaveWorkoutPlan);
        ...
        public static void PremiumFeatureWorkoutPlan(Button btnSaveWorkoutPlan)
        {
        ...
        public static void WorkoutPicsBanner(PictureBox pbWorkout)
        {
        ...
        public static void DynamLoadExercises(string workoutType, Panel pnlExercises)    //here, Dynam means dynamically
        {
        ...
        //for labels
        private static List<Exercise> GetExercises(string workoutType)
        {
        ...
        public static async void SelectExercise(ComboBox cmbExercise, Label lblExerciseInfo)
        {
        ...
        //...........................API...........................
        //ExerciseDB API..
        private static async Task<string> GetExerciseInfo(string targetMuscle)
        {
    ...
    {       { "Lower Back", "spine" },
        ...
        private static string FormatExerciseInfo(string jsonResponse)
        {
