    ...
    internal class DietPlansFormClass
    {
        public static async Task DietPlansFormLoadEvents(Timer timerForPics, PictureBox pbProfilePicture, PictureBox pbMembershipStatus, ListBox lstBreakfastInput, ListBox lstLunchInput, ListBox lstSnacksInput, ListBox lstDinnerInput, RichTextBox richTextBoxNotesInput, ComboBox cmbDietType, TextBox txtFoodItem, RadioButton rbtnOnline)
        {
            ...
            if (UserDataManager.CurrentUser != null)
            {
                ...
                PremiumFeatureDietPlanForm(rbtnOnline);
        ...
        public static void PremiumFeatureDietPlanForm(RadioButton rbtnOnline)
        {
        ...
        //for dynamically adding recipes..
        public static void DynamLoadDietPlans(string dietType, Panel pnlDietPlans)    //dynam=dynamically
        {
        ...
        private static List<DietPlan> GetDietPlans(string dietType)
        {
        ...
        //to display images un 3rd tab (recipes) afer some interval
        private static int imageIndex = 0;

        public static void GetRecipesBanners(PictureBox pbDiet)
        {
            Image[] workoutImages = {
        ...
        private static Dictionary<string, string> nutritionData = new Dictionary<string, string>
        {
        // Fruits
        ...
        public static async void GetSearchButtonResponse(TextBox txtFoodItem, ErrorProvider error, GroupBox groupBoxRadioButtons, RadioButton rbtnOffline, Label lblNutritionInfo, RadioButton rbtnOnline)
        {
            ...
            if (!IsAnyRadioButtonChecked(rbtnOffline, rbtnOnline))
            {
        ...
        private static bool IsAnyRadioButtonChecked(RadioButton rbtnOffline, RadioButton rbtnOnline)
        {
        ...
        private static async Task<string> GetNutritionInfo(string foodItem)
        {
        ...
        // Breakfast
        public static async void SetBreakfastItems(TextBox txtFoodItem, ListBox lstBreakfastInput)
        {
            if (UserDataManager.CurrentUser != null)
            {
        ...
        // Lunch
        public static async void SetLunchItems(TextBox txtFoodItem, ListBox lstLunchInput)
        {
            if (UserDataManager.CurrentUser != null)
            {
                if (txtFoodItem.Text.Contains("Type here") || string.IsNullOrEmpty(txtFoodItem.Text))
        ...
        // Snacks
        public static async void SetSnacksItems(TextBox txtFoodItem, ListBox lstSnacksInput)
        {
            if (UserDataManager.CurrentUser != null)
            {
                if (txtFoodItem.Text.Contains("Type here") || string.IsNullOrEmpty(txtFoodItem.Text))
        ...
        // Dinner
        public static async void SetDinnerItems(TextBox txtFoodItem, ListBox lstDinnerInput)
        {
            if (UserDataManager.CurrentUser != null)
            {
                if (txtFoodItem.Text.Contains("Type here") || string.IsNullOrEmpty(txtFoodItem.Text))
        ...
        private static async Task AddFoodItemToList(string foodItem, ListBox listBox)
        {
        ...
        public static void RemoveFoodItemsFromLists(ListBox lstBreakfastInput, ListBox lstLunchInput, ListBox lstSnacksInput, ListBox lstDinnerInput)
        {
        ...
        public static async void CalculateTotalNutrition(Label lblTotalNutrition, ListBox lstBreakfastInput, ListBox lstLunchInput, ListBox lstSnacksInput, ListBox lstDinnerInput)
        {
            try
            {
        ...
        private static async Task<(int Calories, double Carbs, double Protein, double Fat)> CalculateMealNutritionAsync(ListBox.ObjectCollection items)
        {
            int mealCalories = 0;
            double totalCarbs = 0;
        ...
        private static int ExtractCalories1(string nutritionInfo)
        {
            var match = Regex.Match(nutritionInfo, @"Calories:\s*(\d+)");
            return match.Success ? int.Parse(match.Groups[1].Value) : 0;
        }

        private static double ExtractCarbs(string nutritionInfo)
        {
            var match = Regex.Match(nutritionInfo, @"Carbs:\s*(\d+(\.\d+)?)g");
            return match.Success ? double.Parse(match.Groups[1].Value) : 0.0;
        }

        private static double ExtractProtein(string nutritionInfo)
        {
            var match = Regex.Match(nutritionInfo, @"Protein:\s*(\d+(\.\d+)?)g");
            return match.Success ? double.Parse(match.Groups[1].Value) : 0.0;
        }

        private static double ExtractFat(string nutritionInfo)
        {
        ...
        public static void SaveDietPlan(RichTextBox richTextBoxNotesInput, ListBox lstBreakfastInput, ListBox lstLunchInput, ListBox lstSnacksInput, ListBox lstDinnerInput)
        {
            if (UserDataManager.CurrentUser != null)
            {
